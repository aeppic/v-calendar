...
/* harmony default export */ var CalendarForMonthPickervue_type_script_lang_js_ = ({
  ...
  render(h) {
    ...
    return h('div', {
      ...
      class: ['vc-container-monthpicker', 'CalendarClass', `vc-${this.$theme.color}`, {
        'vc-is-expanded': this.isExpanded,
        'vc-is-dark': this.$theme.isDark
      }],
      on: {
